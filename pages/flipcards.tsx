  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className='absolute w-full h-full bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-lg p-8 flex items-center justify-center'
          style={{
        ...
        >
          <div className='text-center'>
            ...
            <p className='text-xl font-bold text-primary_darker'>
              {question}
            </p>
        ...
        {/* Back of card - Answer */}
        <div
          className='absolute w-full h-full bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow-lg p-8 flex items-center justify-center'
          style={{
            backfaceVisibility: 'hidden',
...
export default function FlipCards() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
      <main className='flex flex-col items-center justify-center flex-1 px-12 text-center w-full max-w-2xl'>
        <h1 className='text-3xl m-10 font-bold text-primary_darker'>
          Flashcards Técnicas Manuais
        </h1>
          ...
          <div className='w-full flex flex-col gap-8'>
            ...
            <div className='w-full overflow-x-hidden'>
              <span className='text-xl font-bold text-primary_darker'>
                Cartão {currentCardIndex + 1} de {shuffledQuestions.length}
              </span>
            ...
            {/* Flip Card */}
            <FlipCard
              question={shuffledQuestions[currentCardIndex]?.question}
              explanation={
                shuffledQuestions[currentCardIndex]?.explanation
              }
              isFlipped={isFlipped}
              onFlip={handleFlip}
            />
            ...
            <div className='flex gap-4 justify-center w-full'>
              <button
                ...
                className='px-6 py-2 rounded-lg bg-gray-300 text-gray-700 font-semibold hover:bg-gray-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
              >
                ← Anterior
              </button>
              <button
                ...
                className='px-6 py-2 rounded-lg bg-primary_darker text-white font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
              >
                Próximo →
              </button>
            </div>
